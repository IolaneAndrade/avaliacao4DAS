...
public class Cliente extends UnicastRemoteObject implements IChat , Runnable {
    private static final long serialVersionUID = 1L;
    private IChat server;
    private String ClientName;
    boolean chkExit = true;
    boolean chkLog = false;
 
    protected Cliente(IChat chatinterface,String clientname,String password) throws RemoteException {
    ...
    public boolean checkClientCredintials(IChat chatinterface ,String clientname,String password) throws RemoteException {
        return true;
    }
    ...
    public static void main(String[] args) throws MalformedURLException,RemoteException,NotBoundException {
        ...
        IChat chatinterface = (IChat)Naming.lookup("rmi://localhost/RMIServer");
        new Thread(new Cliente(chatinterface , clientName , clientPassword)).start();
    }
